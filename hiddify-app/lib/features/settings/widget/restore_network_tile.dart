...
class _RestoreNetworkTileState extends ConsumerState<RestoreNetworkTile> {
  ...
  Future<void> _confirmThenRun() async {
    ...
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (context) => TechDialog(
        title: t.pages.settings.general.restoreNetworkConfirmTitle,
        content: Text(t.pages.settings.general.restoreNetworkConfirmBody),
        actions: [
          ...
          TechDialogActions.ok(
            context,
            label: t.pages.settings.general.restoreNetworkRun,
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(t.pages.settings.general.restoreNetwork, style: theme.textTheme.bodyMedium),
