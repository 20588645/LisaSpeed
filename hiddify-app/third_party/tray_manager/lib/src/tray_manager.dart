...
class TrayManager {
  ...
  /// Sets a compact two-line title next to the tray icon (macOS only),
  /// as used for live network speed readouts. Empty strings clear it.
  Future<void> setTitleLines(String top, String bottom) async {
    final Map<String, dynamic> arguments = {
      'top': top,
      'bottom': bottom,
    };
    await _channel.invokeMethod('setTitleLines', arguments);
  }
