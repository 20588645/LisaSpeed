...
public class TrayManagerPlugin: NSObject, FlutterPlugin, NSMenuDelegate {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "setTitle":
            ...
            break
        case "setTitleLines":
            setTitleLines(call, result: result)
            break
        case "setContextMenu":
    ...
    public func setTitleLines(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        let args:[String: Any] = call.arguments as! [String: Any]
        let top: String = args["top"] as! String;
        let bottom: String = args["bottom"] as! String;
        
        trayIcon?.setTitleLines(top, bottom)
